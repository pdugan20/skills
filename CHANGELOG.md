...
- Versioned execution and routing evals for [`code-native-ui-ideation`](https://github.com/pdugan20/patrick-workflows/tree/v1.1.0/skills/code-native-ui-ideation), [`feature-delivery`](https://github.com/pdugan20/patrick-workflows/tree/v1.1.0/skills/feature-delivery), and [`production-hardening`](https://github.com/pdugan20/patrick-workflows/tree/v1.1.0/skills/production-hardening), enforced by repository validation.
...
- Platform-specific SwiftUI, React Native, and web guidance for [`code-native-ui-ideation`](https://github.com/pdugan20/patrick-workflows/tree/v1.1.0/skills/code-native-ui-ideation), covering runnable variants with consistent fixtures and project-native development surfaces.
...
- Expanded [`code-native-ui-ideation`](https://github.com/pdugan20/patrick-workflows/tree/v1.1.0/skills/code-native-ui-ideation) with an ideate-versus-build branch, a shared comparison contract, and an explicit graduation cleanup boundary.
...
[unreleased]: https://github.com/pdugan20/patrick-workflows/compare/v1.1.0...HEAD
[1.1.0]: https://github.com/pdugan20/patrick-workflows/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/pdugan20/patrick-workflows/releases/tag/v1.0.0
